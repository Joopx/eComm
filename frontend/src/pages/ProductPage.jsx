...
function ProductPage() {
  ...
  const {id} = useParams();
//if in routes in app.jsx i have put id as idx then here also it should be idx
  ...
  if (error || !product){
    return(
      <div className="car bg-base-300 max-w-md mx-auto">
      ...
      <div className="card bg-base-300">
        <div className="card-body">
          ...
          <div className="flex flex-wrap gap-4 text-sm text-base-content/60 my-2">
            ...
            <p className="text-base-content/800 leading-relaxed"> {product.description}</p>
              ...
              <>
                ...
                <div className="flex items-center gap-3">
                  <div className="avatar">
                    <div className="w-12 rounded-full ring ring-primary ring-offset-base-100 ringoffset-2">
